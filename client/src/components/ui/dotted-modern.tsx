...
const DottedModern = () => {
  return (
    <div className="flex flex-col relative h-full w-full min-h-[500px]">
      ...
      <div className="mx-auto h-full flex flex-col gap-6 items-center justify-center relative z-10 p-6">
        <MotionWrapper>
          <a
        ...
        <MotionWrapper>
          <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-medium tracking-tight leading-[1.05] text-slate-900 text-center">
            Action - oriented
            <br />
        ...
        <MotionWrapper>
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto pt-2">
            ...
            <button className="w-full sm:w-auto px-6 py-3 rounded-sm font-semibold text-sm text-slate-600 border border-slate-200 hover:bg-slate-50 hover:text-slate-900 transition-all flex items-center justify-center gap-2 bg-white cursor-pointer">
